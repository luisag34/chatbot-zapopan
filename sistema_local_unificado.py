"""
SISTEMA LOCAL UNIFICADO - TODO EN UN ARCHIVO
Evita problemas de importación en Streamlit Cloud
"""
...
class SistemaLocalUnificado:
    """Sistema local TODO EN UNO para evitar import issues"""
    ...
    def _cargar_base_conocimiento_completa(self) -> Dict:
        """Cargar base de conocimiento COMPLETA con 13 temas"""
        return {
    ...
    def _tema_taxi(self) -> Dict:
        return {
            ...
            "dependencias": """Movilidad y Transporte (ext. 3810-3812), Inspección y Vigilancia (ext. 3312-3313), Policía Municipal (ext. 060).""",
            "fuentes": """Reglamento de Transporte Público de Zap